...
<head>
    <title>E-Recrutment Anggota Organisasi Universitas Brawijaya</title>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="{{ asset('andrea/css/magnific-popup') }}">
                    ...
                    <div class="row d-flex">
                        <div class="col-xl-8 py-5 px-md-5">
                            <div class="row pt-md-4">
                                ...
                                <!-- <div class="col-md-12">
                                    <div class="blog-entry ftco-animate d-md-flex">
                                        <a href="{{ url('andrea/single.html') }}" class="img img-2" style="background-image: url(images/image_2.jpg);"></a>
                                        <div class="text text-2 pl-md-4">
                                            <h3 class="mb-2"><a href="{{ url('andrea/single.html') }}">Great Things Never Came from Comfort Zone</a></h3>
                                            <div class="meta-wrap">
                                                <p class="meta">
                                                    <span><i class="icon-calendar mr-2"></i>June 28, 2019</span>
                                ...
                                <div class="col-md-12">
                                    <div class="blog-entry ftco-animate d-md-flex">
                                        <a href="{{ url('andrea/single.html') }}" class="img img-2" style="background-image: url(images/image_3.jpg);"></a>
                                        <div class="text text-2 pl-md-4">
                                            <h3 class="mb-2"><a href="{{ url('andrea/single.html') }}">Paths Are Made by Walking</a></h3>
                                            <div class="meta-wrap">
                                                <p class="meta">
                                                    <span>Dec 14, 2018</span>
                                                    <span><a href="{{ url('andrea/single.html') }}">Lifestyle</a></span>
                                                    <span>5 Comment</span>
                                                </p>
                                            </div>
                                            <p class="mb-4">A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
                                ...
                                <div class="col-md-12">
                                    <div class="blog-entry ftco-animate d-md-flex">
                                        <a href="{{ url('andrea/single.html') }}" class="img img-2" style="background-image: url(images/image_4.jpg);"></a>
                                        <div class="text text-2 pl-md-4">
                                            <h3 class="mb-2"><a href="{{ url('andrea/single.html') }}">The Secret of Getting Ahead is Getting Started</a></h3>
                                            <div class="meta-wrap">
                                                <p class="meta">
                                                    <span>Dec 14, 2018</span>
                                                    <span><a href="{{ url('andrea/single.html') }}">Nature</a></span>
                                                    <span>5 Comment</span>
                                                </p>
                                            </div>
                                            <p class="mb-4">A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
                                ...
                                <div class="col-md-12">
                                    <div class="blog-entry ftco-animate d-md-flex">
                                        <a href="{{ url('andrea/single.html') }}" class="img img-2" style="background-image: url(images/image_5.jpg);"></a>
                                        <div class="text text-2 pl-md-4">
                                            <h3 class="mb-2"><a href="{{ url('andrea/single.html') }}">You Can't Blame Gravity for Falling in Love</a></h3>
                                            <div class="meta-wrap">
                                                <p class="meta">
                                                    <span>Dec 14, 2018</span>
                                                    <span><a href="{{ url('andrea/single.html') }}">Lifestyle</a></span>
                                ...
                                <div class="col-md-12">
                                    <div class="blog-entry ftco-animate d-md-flex">
                                        <a href="{{ url('andrea/single.html') }}" class="img img-2" style="background-image: url(images/image_6.jpg);"></a>
                                        <div class="text text-2 pl-md-4">
                                            <h3 class="mb-2"><a href="{{ url('andrea/single.html') }}">You Can't Blame Gravity for Falling in Love</a></h3>
                                            <div class="meta-wrap">
                                                <p class="meta">
                                                    <span>Dec 14, 2018</span>
                                                    <span><a href="{{ url('andrea/single.html') }}">Travel</a></span>
                                                    <span>5 Comment</span>
                                                </p>
                                            </div>
                                            <p class="mb-4">A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
                                ...
                                <div class="col-md-12">
                                    <div class="blog-entry ftco-animate d-md-flex">
                                        <a href="{{ url('andrea/single.html') }}" class="img img-2" style="background-image: url(images/image_7.jpg);"></a>
                                        <div class="text text-2 pl-md-4">
                                            <h3 class="mb-2"><a href="{{ url('andrea/single.html') }}">You Can't Blame Gravity for Falling in Love</a></h3>
                                            <div class="meta-wrap">
                                                <p class="meta">
                                ...
                                <div class="col-md-12">
                                    <div class="blog-entry ftco-animate d-md-flex">
                                        <a href="{{ url('andrea/single.html') }}" class="img img-2" style="background-image: url(images/image_8.jpg);"></a>
                                        <div class="text text-2 pl-md-4">
                                            <h3 class="mb-2"><a href="{{ url('andrea/single.html') }}">You Can't Blame Gravity for Falling in Love</a></h3>
                                            <div class="meta-wrap">
                                                <p class="meta">
                                ...
                                <div class="col-md-12">
                                    <div class="blog-entry ftco-animate d-md-flex">
                                        <a href="{{ url('andrea/single.html') }}" class="img img-2" style="background-image: url(images/image_9.jpg);"></a>
                                        <div class="text text-2 pl-md-4">
                                            <h3 class="mb-2"><a href="{{ url('andrea/single.html') }}">You Can't Blame Gravity for Falling in Love</a></h3>
                                            <div class="meta-wrap">
                                                <p class="meta">
                                ...
                                <div class="col-md-12">
                                    <div class="blog-entry ftco-animate d-md-flex">
                                        <a href="{{ url('andrea/single.html') }}" class="img img-2" style="background-image: url(images/image_10.jpg);"></a>
                                        <div class="text text-2 pl-md-4">
                                            <h3 class="mb-2"><a href="{{ url('andrea/single.html') }}">You Can't Blame Gravity for Falling in Love</a></h3>
                                            <div class="meta-wrap">
                                                <p class="meta">
                                ...
                                <div class="col-md-12">
                                    <div class="blog-entry ftco-animate d-md-flex">
                                        <a href="{{ url('andrea/single.html') }}" class="img img-2" style="background-image: url(images/image_11.jpg);"></a>
                                        <div class="text text-2 pl-md-4">
                                            <h3 class="mb-2"><a href="{{ url('andrea/single.html') }}">You Can't Blame Gravity for Falling in Love</a></h3>
                                            <div class="meta-wrap">
                                                <p class="meta">
                                ...
                                <div class="col-md-12">
                                    <div class="blog-entry ftco-animate d-md-flex">
                                        <a href="{{ url('andrea/single.html') }}" class="img img-2" style="background-image: url(images/image_12.jpg);"></a>
                                        <div class="text text-2 pl-md-4">
                                            <h3 class="mb-2"><a href="{{ url('andrea/single.html') }}">You Can't Blame Gravity for Falling in Love</a></h3>
                                            <div class="meta-wrap">
                                                <p class="meta">
