...
<div class="col-lg-8 px-md-5 py-5">
    <div class="row pt-md-4">
        ...
        <p>
            <img src="{{ url('andrea/images/image_1.jpg') }}" alt="" class="img-fluid">
        </p>
        <div class="half">
            <p><a href="/form/{{ $blog->id }}" class="btn btn-primary p-3 px-xl-4 py-xl-3">Daftar Sekarang</a></p>
        </div>
        ...
        <p>
            <img src="{{ url('andrea/images/image_2.jpg') }}" alt="" class="img-fluid">
        </p>
                                ...
                                <li class="comment">
                                    ...
                                    <ul class="children">
                                        <li class="comment">
                                            ...
                                            <div class="comment-body">
                                                <h3>John Doe</h3>
                                                <div class="meta">October 03, 2018 at 2:21pm
                                                </div>
